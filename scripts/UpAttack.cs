...
public class UpAttack : MonoBehaviour
{
    ...
    {
        if (m_Player.m_EnemyMiddleIsIn == true || m_Player.m_EnemyDownIsIn == true) // if the wrong button is pressed
        {
