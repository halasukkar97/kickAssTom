...
public class DBInteraction {
    ...
    public void updateUser(int UserID, string UserName, string Password, int Money, int LevelProgress, int Hearts, int Bombs, int Shields, int Potions)
    {
        ...
        string postString = UpdateUserURL + "UserID= "+ UserID
                                        + "&Name=" + UserName
                                        + "&Password=" + Password
                                        + "&Money= " + Money
    ...
    public void updateUserScore(int UserID, string UserName, string Password, int Stage, int Score)
    {
        ...
        string hash = CreateMD5(UserName + Password + secretKey);
        string postString = UpdateUserScoreURL + "UserID=" + UserID + "&Name=" + UserName + "&Password=" + Password + "&Stage=" + Stage + "&Score=" + Score + "&hash=" + hash;
        WWW post = new WWW(UpdateUserScoreURL + postString);
    ...
    public bool CreateUserScoreEntrties(int UserID, string UserName, string Password)
    {
        ...
        for(int i=0; i<5; i++)
        {
            string postString = NewUserScoreURL + "UserID=" + UserID + "&Name=" + UserName + "&Password=" + Password + "&Stage=" + (i+1) + "&hash=" + hash;
